...
class WPBannerizeWidget extends WP_Widget {
	...
	function WPBannerizeWidget() {
		...
		$widget_ops = array(
			'classname' => kWPBannerizeWidgetClassName,
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('random'); ?>"><?php _e('Random', 'wp-bannerize'); ?>:</label>
		...
		<label for="<?php echo $this->get_field_id('no_html_wrap'); ?>"><?php _e('No HTML wrap', 'wp-bannerize'); ?>:</label>
	...
	<p>
		<label for="<?php echo $this->get_field_id('before'); ?>"><?php _e('HTML Tag before banner', 'wp-bannerize'); ?>:</label>
		<input type="text" size="8" value="<?php echo $before ?>" name="<?php echo $this->get_field_name('before'); ?>"
			   id="<?php echo $this->get_field_id('before'); ?>"/>
	</p>
	<p>
		<label for="<?php echo $this->get_field_id('after'); ?>"><?php _e('HTML Tag after banner', 'wp-bannerize'); ?>:</label>
		<input type="text" size="8" value="<?php echo $after ?>" name="<?php echo $this->get_field_name('after'); ?>"
